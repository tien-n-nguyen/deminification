...
\noindent {\bf Key Idea 2.} [{\bf Relations among Variables in a
  ...
  with that variable} in the surrounding context. We leverage Label,
Graph Convolution Network (Label-GCN)~\cite{label-gcn} to model
different kinds of relations among the variables and among their
...
It then uses that knowledge to predict the variable name \code{range}.
