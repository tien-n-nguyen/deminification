...
program dependency graph of variables and surrounding program
entities. It infers the variable names as a problem of structured
prediction with conditional random fields (CRFs)~\cite{JSNice2015}.
JSNice~\cite{JSNice2015} still has low accuracy with its
probabilistic, graphical model approach.
%
