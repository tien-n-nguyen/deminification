...
ran the baselines with the parameters in their source code. We fed to
{\tool} the minified code, and obtained the
output types from the variable type generation (VTG) model for all the
