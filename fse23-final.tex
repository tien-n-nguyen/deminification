...
variable name prediction, in 76.7\% and {\color{blue}{81.6\%}}
%{\color{blue}{79.9\%}}
of the cases {\color{blue}{in Python and JS code respectively}},
{\tool} can predict correctly the variables' names with a single
suggested name. {\tool} relatively improves 15.3\%--40.7\%
%{\color{blue}{and 5.4--46.6\%}}
{\color{blue}{and 7.7\%--49.7\%}}
in top-1 accuracy over the state-of-the-art variable name recovery
approaches {\color{blue}{for Python and JS code, respectively}}. It
also relatively improves 14.5\%--51.9\% in top-1 accuracy over the
