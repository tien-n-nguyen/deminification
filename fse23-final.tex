...
{\color{blue}{a JavaScript (JS) dataset with XXXk methods}}. For
...
respectively}}. It also relatively improves 14.5--51.9\% in top-1
accuracy over the existing type prediction approaches. Our
experimental results showed that learning of data types help improve
