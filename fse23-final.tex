...
{\color{blue}{a JavaScript (JS) dataset with 322k files}}. For
variable name prediction, in 76.7\% and {\color{blue}{79.9\%}} of the
...
5.4--46.6\%}} in top-1 accuracy over the state-of-the-art variable
