...
\title[{\tool}: Neural Variable Name Recovery for Minified Code]
{{\tool}: Neural Variable Name Recovery for Minified Code}
...
type prediction is 79\%. It relatively improves 14.5\%--51.9\% in top-1
